...
var engine, world;
var box1, pig1,platform,backgroundimage;
var state = "true";
var gamestate="attached1";
var bg1 = "sprites/bg"
...
{
    if(gamestate==="attached1")
 {
       Matter.Body.setPosition(bird.body,{x:mouseX,y:mouseY});
 }   
    if(gamestate==="attached2"&&state==="false")
 {
...
function keyPressed() 
{
    if (keyCode===32&&gamestate==="attached2")
    {
